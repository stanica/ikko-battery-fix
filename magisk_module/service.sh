...
OFFSET1=2480   # FEEDFACECAFEBABE - eta6965_charger:dump_register
OFFSET2=2616   # DEADC0DEBEEFCAFE - eta6965_charger_sec:dump_register
OFFSET3=2752   # CAFEBABE12345678 - eta6965_charger:enable_vbus
OFFSET4=2888   # DEADBEEF87654321 - eta6965_charger:disable_vbus
OFFSET5=3024   # BAADF00DDEADBEEF - eta6965_charger:get_property
...
if [ -z "$ADDR1" ] || [ -z "$ADDR2" ] || [ -z "$ADDR3" ] || [ -z "$ADDR4" ] || [ -z "$ADDR5" ]; then
